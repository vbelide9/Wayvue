...
export default function App() {
  ...
  const handleSegmentSelect = (condition: RoadCondition) => {
    if (condition.location) {
      setSelectedLocation(condition.location);
    }
  };
    ...
    <main className="flex h-screen overflow-hidden bg-background text-foreground font-sans">
      ...
      <div className="flex-1 lg:basis-[65%] flex flex-col relative min-w-0">
        ...
        <div className="absolute top-4 left-4 right-4 z-[400] flex flex-col gap-2 pointer-events-none">
          ...
          {route && (
            <div className="flex items-center gap-2 pointer-events-auto animate-in slide-in-from-top-2 fade-in">
        ...
        <div className="flex-1 relative z-0">
          ...
          {/* Map Corner Overlays (Weather) */}
          {weatherData.length > 0 && (
            <>
              <div className="absolute top-36 left-4 z-[400] pointer-events-none">
                <WeatherCard
                  variant="overlay"
                  unit={unit}
                  weather={{
              ...
              <div className="absolute top-36 right-4 z-[400] pointer-events-none">
                <WeatherCard
                  variant="overlay"
                  unit={unit}
                  weather={{
