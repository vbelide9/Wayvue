...
export function HotelRecommendationCard({ data, links }: HotelRecommendationProps) {
    ...
    return (
        <motion.div
            ...
            className="group relative bg-card border border-border rounded-3xl p-6 sm:p-8 shadow-soft mt-6 flex flex-col gap-6 overflow-hidden transition-all duration-500 hover:border-primary/30 hover:shadow-soft-lg"
        >
            ...
            <div className="flex flex-col justify-between items-start gap-4 relative z-10">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="font-bold text-foreground text-lg tracking-tight">Smart Stay Match</h3>
                ...
                <div className="bg-secondary/50 border border-border rounded-2xl p-4 flex flex-col items-start gap-1 w-full shadow-inner group-hover:bg-secondary transition-colors duration-300">
                    ...
                    <span className="text-xl font-black text-foreground tracking-tighter drop-shadow-md">
            ...
            {/* AI Reasoning block */}
            <div className="relative z-10 text-sm text-foreground/70 leading-relaxed bg-secondary/60 p-5 rounded-2xl border border-border shadow-inner font-light tracking-wide">
                ...
                {data.options.map((option, i) => (
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center gap-1 shrink-0 md:mx-4">
                            {option.avgPrice && (
                                <span className="text-2xl font-black text-foreground tracking-tight drop-shadow-md">
                                    {option.avgPrice}
                                </span>
                            )}
                            {option.total && (
            ...
            {/* Disclaimer */}
            <div className="flex items-start gap-3 text-xs text-muted-foreground mt-4 pt-4 border-t border-border relative z-10">
