...
// Run a standalone HTTP server only when invoked directly (local dev). When required as a
// module (e.g. wrapped by the Firebase Function), just export the Express app.
